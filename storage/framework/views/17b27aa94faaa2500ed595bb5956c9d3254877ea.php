...
<div class="sidebar">
	...
	<ul class="sidebar-items">
		...
		<li><a href="<?php echo e(route('candidate-status',['status'=>'selected'])); ?>">Select List</a></li>
		<li><a href="<?php echo e(route('candidate-status',['status'=>'pending'])); ?>">Pending List</a></li>
		<li><a href="<?php echo e(route('candidate-status',['status'=>'rejected'])); ?>">Rejected List</a></li>
	</ul>
</div>
